...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///opensteer")
}
...
MIGRATION_MODULES = {"sites": "opensteer.contrib.sites.migrations"}
...
ADMINS = [('dhilipsiva', "dhilip@reckonsys.com")]
